                    ...
                    renderItem={({ item }) => (
                        <Card key={item._id} >
                            <View style={styles.col}>
                                ...
                                <View>
                                    <Text style={[styles.smallFont, styles.italicFont]}> {item.role} </Text>
                                </View>
                                <Text style={styles.smallFont}>Email: {item.email} </Text>
                                <Text style={styles.smallFont}>Phone: {item.phone} </Text>
                            </View>
                            <CardSection>
                                <Text style={styles.divider}></Text>
                            </CardSection>
                            <CardSection>
                                <Text style={styles.smallFont}> Next available:  {moment(item.date).format('DD-MMM-YYYY')} </Text>
                            </CardSection>
                            <CardSection>
                                <ButtonN onPress={() => { this.bookAppoinment(item); }}>
                                    Book Appoinment
                            </ButtonN>
                            </CardSection>
                        </Card>
